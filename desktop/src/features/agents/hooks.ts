...
export function useRelayAgentsQuery(options?: { enabled?: boolean }) {
  return useQuery({
    ...
    // re-pulls the full set app-wide. Local kind:10100 reconciliation emits
    // `agents-data-changed`; this relaxed poll remains the fallback for
    // profiles published by remote/provider Agents.
