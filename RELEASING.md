...
The first formal support matrix is Linux-focused. Web and other retained source
trees are not automatically release artifacts. The inherited Mobile,
experimental Harbor benchmark, Helm/Kubernetes, and hosted Push Gateway
surfaces are retired and are not Carryforth release targets.
