...
-- ── Open Role Proposal guard (migration 0036) ─────────────────────────────
...
--
-- pgvector is an operator-installed PostgreSQL prerequisite. The desired
-- schema uses its types directly; migration 0057 performs the version probe.
...
-- Migration 0058.
-- Project Context semantic-query admission foundation. Capability-off.
