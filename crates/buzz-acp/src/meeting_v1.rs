...
const V2_ACTION_FINALIZATION_TOOLS: &str = "normally exposed business tools, including buzz project-view, buzz documents, buzz project-context, buzz roles, and the controlled buzz meetings update/show retrieval-summary surface, for the moderator to materialize exact frozen-Board decisions and maintain their explicit explanatory context; do not publish Meeting State, Board, Action, End, or other protocol events";
