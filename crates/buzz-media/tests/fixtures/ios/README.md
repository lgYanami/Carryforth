...
encoded/sanitized hashes are recorded in
...
3. Copy the encoded files into this directory. Run the tracked sanitizer paths
   to create both sanitized outputs; do not substitute a different image
   encoder.
...
scanlines. Regenerate encoded and sanitized pairs together whenever UIKit or
