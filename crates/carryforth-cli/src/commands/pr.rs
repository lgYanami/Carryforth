...
pub async fn cmd_get_pr(client: &CarryforthClient, event: &str) -> Result<(), CliError> {
...
pub async fn dispatch(cmd: crate::PrCmd, client: &CarryforthClient) -> Result<(), CliError> {
    use crate::PrCmd;
    match cmd {
        PrCmd::Open {
            repo_owner,
