...
use crate::client::{normalize_events, normalize_write_response, CarryforthClient};
...
async fn resolve_channel_id(client: &CarryforthClient, event_id: &str) -> Result<Uuid, CliError> {
...
async fn resolve_author(client: &CarryforthClient, author: &str) -> Result<String, CliError> {
