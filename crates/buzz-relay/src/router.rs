...
async fn status_handler(State(state): State<Arc<AppState>>) -> impl IntoResponse {
    ...
    Json(json!({
        ...
        "project_context_coordinate_search_http": {
            "runtime_digest": semantic_query_runtime_digest.clone(),
            "parser_ready": true,
            "handler_ready": semantic_query_handler_ready,
            "deployment_master": state.config.project_context_coordinate_search_http_available,
            "fleet_policy": state.config.semantic_graph_query_fleet_policy.as_str(),
            "fleet_attestation_required": fleet_attestation_required,
            "fleet_attestation_status": fleet_attestation_status,
            "deployment_id": state.config.semantic_graph_query_deployment_id,
        ...
        "project_context_one_hop_semantic_search_http": {
            "runtime_digest": semantic_query_runtime_digest,
            "parser_ready": true,
            "handler_ready": semantic_query_handler_ready,
            "deployment_master": state.config.project_context_one_hop_semantic_search_http_available,
            "fleet_policy": state.config.semantic_graph_query_fleet_policy.as_str(),
            "fleet_attestation_required": fleet_attestation_required,
            "fleet_attestation_status": fleet_attestation_status,
            "deployment_id": state.config.semantic_graph_query_deployment_id,
