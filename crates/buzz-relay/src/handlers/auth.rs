...
pub async fn handle_auth(event: nostr::Event, conn: Arc<ConnectionState>, state: Arc<AppState>) {
        ...
        .await
    {
        Ok(mut auth_ctx) => {
            ...
            let community_private_read_eligible =
                crate::handlers::community_private::credential_can_read_community_private(
                    &auth_ctx.scopes,
            ...
            *conn.auth_state.write().await = AuthState::Authenticated(auth_ctx);
            ...
            state
                .conn_manager
                .set_community_private_read_eligible(conn_id, community_private_read_eligible);
