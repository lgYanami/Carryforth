#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Carryforth private team communication.
...
mod meeting_observability;
/// Meeting V0 deadline recovery and transactional outbox delivery.
pub mod meeting_runtime;
