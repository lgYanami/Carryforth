...
合并 Project View 后，迁移使用 `0037_meeting_v0_lifecycle.sql`。`0025`–`0031`
...
迁移使用 `0038_meeting_v0_floor.sql`，新增轮次、Claim 和持久 outbox 表，并给
...
- 迁移使用 `0039_meeting_v0_agent_floor.sql`，共享协议夹具同步登记 kind `42104`。
...
- 在会议 `77b68261-57f3-47db-ac89-ffcb4ea4c9c9` 中，Agent 自动同步上下文、读取
  `../../project-positioning.md`、选择 CLAIM、获权，并在约 13 秒内提交 speech
