...
> 状态：第一版设计
>
> 历史说明：本文记录早期 V0 设计，后续产品语义已经演进到
> [Meeting V2](v2/meeting-v2.md)。当前[项目空间宪章](../../project-space-constitution.md)
> 不再把通用候选决议、人类确认或独立 Project Decision 领域视为现行能力。
>
...
共享协作空间。本文写作时曾把正式会议设想为带候选决议与人类确认的未来治理机制；这部分设想
已经被后续 V2 和现行宪章取代。V0 当时只验证一个更基础的问题：
...
本节保留 V0 阶段当时的演进设想，仅用于理解历史，不代表当前产品路线或现行宪章合同。
当前 Meeting 边界以 [Meeting V2](v2/meeting-v2.md) 为准。
