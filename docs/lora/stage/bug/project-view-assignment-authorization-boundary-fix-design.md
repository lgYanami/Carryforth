...
1. 在 `docs/lora/stage/project-view/changelog.md` 记录事故、根因和修复；
2. 在 `docs/lora/stage/role/changelog.md` 记录 Community ACL 与 Role fence重新分层；
3. 修正 `docs/lora/stage/role/implementation-design.md` 中“managed Agent 普通对象写入必须
