...
合并 Project View 后，阶段一使用 `0040_meeting_v1_baton.sql`，阶段二使用
`0041_meeting_v1_stage2.sql`，Moderator Attempt 使用
`0042_meeting_v1_moderator_attempts.sql`。迁移保持 additive，不删除 V0 数据和约束语义。
