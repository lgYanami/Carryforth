...
```text
migrations/0049_project_context_edge.sql
```
...
- 增加 migration `0049_project_context_edge.sql`，并以
  `0050_project_context_edge_builtin_sha256.sql` 固化 fresh-schema 路径的内建 SHA-256，
  同步 `schema/schema.sql` 和 migration tests；
