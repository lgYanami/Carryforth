...
export const mockRepos: Repo[] = [
  {
    id: "carryforth-desktop",
    name: "carryforth-desktop",
    description:
      "The desktop client for collaborating with people and agents across Carryforth communities.",
    cloneUrls: ["https://example.com/carryforth-desktop.git"],
    webUrl: null,
    channelId: null,
    owner: people.ada,
