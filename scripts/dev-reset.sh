...
# Installed Carryforth state at the stable compatibility coordinates is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Carryforth app state and its stable keyring are preserved."
...
success "Desktop development state removed (installed Carryforth state preserved)"
