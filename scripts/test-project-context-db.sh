...
if [[ -z "${PROJECT_CONTEXT_TEST_DATABASE_URL:-}" ]]; then
  ...
  PROJECT_CONTEXT_TEST_DATABASE_URL="postgres://buzz:buzz_dev@localhost:5432/postgres"
fi

export TEST_DATABASE_URL="${PROJECT_CONTEXT_TEST_DATABASE_URL}"
